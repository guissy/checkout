...
const CurrencySelect: React.FC<FpCurrencyProps> = ({
  lang,
  value,
  currencyInfo,
  setValue,
          ...
          currencyInfo
            ...
            .map((it) => (
              ...
              >
                ...
                <span
                  className={
                    "block text-[#99A0AB] text-sm font-medium empty:hidden"
                  }
                >
                  {i18n.locale === "zh" ? it?.currencyName : it?.currencyNameEn}
                </span>
              </SelectItem>
            ))}
        <div
          className={
            "sr-only only:not-sr-only text-[#99A0AB] text-center py-10"
          }
        >
          No Data
        </div>
